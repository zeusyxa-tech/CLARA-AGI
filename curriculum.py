...
LEVELS = [
    ...
    },
    {
        ...
        "topics": [
            ...
            "open-source AI contributor reward program",
            "AI content creation service for business",
            "AI chatbot agency for local business Vietnam",
            "online AI course creation and tutoring",
            "AI data annotation remote work",
            "AI tool for disabled users fundraising",
            "green AI energy optimization service",
            "AI automation for e-commerce Vietnam"
        ],
        "priority": 1.0,
        "bucket": "income",
    },
